...
function AddSignature({ navigation }) {
    ...
    const handleSave = async () => {
        ...
        const svg = `<svg xmlns="http://www.w3.org/2000/svg" width='200' height='200' viewBox='0 0 ${width / 10} ${height}' >
    ...
    return (
        <>
            ...
            <View style={styles.buttonsSignature}>

                <GradientButton text={`Sauvegarder`}
                    handlePress={handleSave} />

                <GradientButton text={`recommencer`}
                    handlePress={() => setPath([])}
                />
