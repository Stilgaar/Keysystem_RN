...
function VehiculesInfo({ globalState, navigation }) {

    return (

        <>
            <View style={[generalStyles.topGreyContainer, generalStyles.globalShadow, { marginTop: 5 }]}>
            ...
            <View style={[generalStyles.bottomWhiteContainer, generalStyles.globalShadow, globalState.center, { flexDirection: 'row', marginBottom: 5 }]}>

                <View style={{ flex: 0.5, justifyContent: "center", alignItems: "center" }}>

                    <GradientButton width={60} borderRadius={50} buttonPadding={5} handlePress={() => navigation.navigate("CarMap")}>
